    ...
    renderModalTicket(className,ticketNum){
        ...
        return(
            <div style={modalStyles.ticket}>
                <span style={modalStyles.comingSoon(className)}>Coming Soon</span>
                <div style={{width: '100%', height: '100%', opacity: className === "dressUpTicket" ? '0.2' : '1' }}>
                    <button
                    ...
                    <div style={modalStyles.ticketUseButtonWrapper}>
                        <button
                            ...
                            style={modalStyles.userButton}
                            onClick={()=>this.useTicket(ticketName)}
                            disabled={className === 'dressUpTicket' ? true : false}
                        >use ></button>
